...
<!-- TextAndMedia -->
<section class="py-16 bg-white border-y-[64px] border-yellow-300 relative overflow-hidden">
  <!-- ArrowDecor -->
  ...
  <div class="wrapper relative">
    <div class="box">
      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-x-6">
        ...
        <!-- Media -->
        <figure class="border-2 border-yellow-300 shadow-lg rounded-xl overflow-hidden relative group cursor-pointer h-fit mb-8 lg:mb-0 lg:col-span-6 lg:col-start-7" onclick="playPauseVideo(this)">
