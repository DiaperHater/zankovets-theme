    ...
    <div class="wrapper">
      <div class="box">
        ...
        <div class="w-[920px] max-w-full mx-auto border-b border-b-yellow-300 pb-8 mb-12 md:grid md:grid-cols-8 md:gap-x-6 lg:items-center">
          <!-- Logo -->
          <a href="<?= home_url() ?>" class="text-4xl text-yellow-300 leading-none font-bold uppercase duration-200 hover:text-yellow-500  block text-center mb-12 md:col-span-2 md:col-start-4 md:mb-0">
            Zankovets
          </a>
          <!-- leftColumn -->
        ...
        <!-- Sign -->
        <p class="text-center font-light text-yellow-300">
          © 2024
        </p>
      </div>
    </div>
